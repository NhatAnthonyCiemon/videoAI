export default function CreateScript() {
  return (
    <div className="p-8 bg-gray-200 min-h-screen">
      <div className="m-20 bg-gray-100 p-20">
        <h1 className="text-2xl font-bold mb-6 text-gray-800">Tạo Video AI</h1>
        {/* Tabs */}
        <div className="flex justify-between mb-6">
            <button className="px-4 py-2 bg-gray-300 text-gray-800 rounded-md hover:bg-black hover:text-white w-1/4">
                ...
                {[1, 2, 3].map((voice) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Nữ - Mô tả</p>
                    </div>
