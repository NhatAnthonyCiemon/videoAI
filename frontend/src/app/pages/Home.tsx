...
export default function HomePage() {
    ...
    return (
        <main className="w-full min-h-screen bg-black text-white overflow-x-hidden text-[19px] md:text-[20px] lg:text-[21px] leading-relaxed">
            ...
            {/* Hero */}
            <section className="bg-gradient-to-r from-indigo-900 to-purple-800 text-white bg-cover bg-right bg-no-repeat py-50 md:py-80" style={{ backgroundImage: 'url(/img/robot.png)' }}>
                <div className="w-full max-w-screen-lg xl:max-w-[70%] mx-auto px-4 flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 space-y-6">
                        ...
                        <p className="text-4xl opacity-90">Khám phá cách tạo ra những video Tiktok, Instagram, Youtube Shorts đỉnh cao từ từ khóa xu hướng, AI tự động sinh kịch bản, giọng đọc và video hoàn chỉnh cho bạn</p>
                        <div className="pt-4 flex flex-wrap gap-4">
                            <Button className="bg-green-500 hover:bg-green-600 text-white text-2xl px-8 py-9 rounded-xl">
                                Bắt đầu ngay
                            </Button>
                            <Button variant="link" className="text-white text-2xl p-9">
                                Xem thử video mẫu
                            </Button>
                        </div>
                    </div>
            ...
            <section className="bg-pink-50 text-black py-24 px-6">
                <div className="w-full max-w-screen-lg xl:max-w-[70%] mx-auto text-center space-y-12">
                    ...
                    <p className="text-gray-600 text-2xl">Khám phá các công cụ mạnh mẽ giúp bạn tạo ra những video ngắn chất lượng cao</p>
                            ...
                            [
                                {
                                    ...
                                    icon: (
                                        <svg className="w-10 h-10 text-pink-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M15 11l4.553-4.553a1.414 1.414 0 00-2-2L13 9m2 2l-9 9a1.5 1.5 0 01-2.121-2.121l9-9" />
                                ...
                                },
                                {
                                    ...
                                    icon: (
                                        <svg className="w-10 h-10 text-pink-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                ...
                                },
                                {
                                    ...
                                    icon: (
                                        <svg className="w-10 h-10 text-pink-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 2a7 7 0 00-7 7c0 2.485 1.5 4.623 3.5 6v2a1.5 1.5 0 001.5 1.5h4a1.5 1.5 0 001.5-1.5v-2c2-1.377 3.5-3.515 3.5-6a7 7 0 00-7-7z" />
                                ...
                                },
                                {
                                    ...
                                    icon: (
                                        <svg className="w-10 h-10 text-pink-600" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 17.75l-6.172 3.244L7 14.708 2.5 9.755l6.372-.927L12 3l3.128 5.828 6.372.927-4.5 4.953 1.172 6.286z" />
                                        </svg>
                                    )
                                }
                ...
                <div className="w-full max-w-screen-lg xl:max-w-[70%] mx-auto text-center space-y-12">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {Array.from({ length: 12 }).map((_, i) => (
                            <div key={i} className="aspect-video bg-black rounded-2xl overflow-hidden shadow-lg relative group">
                                <video
