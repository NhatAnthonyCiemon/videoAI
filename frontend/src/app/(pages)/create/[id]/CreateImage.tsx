...
export default function CreateImage({
  ...
  const handleCreateVideo = async () => {
    ...
    if (res.mes === "success") {
      ...
      const newVideoData2 = videoClass.updateVideo(newVideoData6, "step", 2);
            ...
            {videoData.image_video.map((img, index) => (
              <div key={index} className="bg-white p-6 rounded-md shadow-md">
                  ...
                  <div className="col-span-1 h-[100%] min-h-[200px] bg-gray-300 rounded-md relative">
                    ...
                    <img
                      ...
                      className={`w-full h-full object-cover rounded-md ${
                        loadingIndexes.has(index) ? "opacity-50" : "opacity-100"
                      }`}
                    />
                  </div>
                      ...
                      {isCustomVoice ? (
                        <Mp3Uploader
                          ...
                          onUpload={(file) => {
                            ...
                            const image_video = [...videoData.image_video];
                            image_video[index].file_mp3 = file; // hoặc có thể upload lên cloud trước rồi lưu url
                            setVideoData(
                        ...
                        <textarea
                          ...
                          onChange={(e) => {
                            const image_video = [...videoData.image_video];
                            image_video[index].content = e.target.value;
                            setVideoData(
                              videoClass.updateVideo(
                                videoData,
                                "image_video",
                    ...
                    <div className="ml-[-5px]">
                      ...
                      <textarea
                        ...
                        onChange={(e) => {
                          ...
                          const image_video = [...videoData.image_video];
                          image_video[index].prompt = e.target.value;
                          setVideoData(
                            videoClass.updateVideo(
                              videoData,
                              "image_video",
                ...
                <div className="flex justify-end mt-4">
                  ...
                  >
                    {loadingIndexes.has(index) ? "Đang tạo lại..." : "Tạo lại"}
                  </button>
                </div>
              </div>
            ))}
